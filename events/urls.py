...
urlpatterns = [
    ...
    path('custom-admin/tickets/<int:ticket_id>/resend/', admin_views.resend_ticket, name='admin_resend_ticket'),
    path('custom-admin/tickets/<int:ticket_id>/cancel/', admin_views.cancel_ticket, name='admin_cancel_ticket'),
